# -*- coding: utf-8 -*-
"""
Created on Tue Feb 16 12:27:57 2016
Battleship
@author: Anna
"""
...
You'll also want to make sure that you balance the size of the board with the number 
of ships so the game is still challenging and fun to play.
